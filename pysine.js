...
//    Can be added if we progress to sounds (series of tones) rather than just tones
//    mod.soundObj = {
...
// function call for goal #1 of playing a single note passed as a string
//mod.pysine = new Sk.builtin.func(function(note) {
//   return Sk.misceval.callsimArray(Sk.builtin.str.prototype['pysine'], [note]);

//Sk.builtin.pyCheckType(“string”);


mod.pysine = new Sk.builtin.func(function(frequency, wave, time) {
    return Sk.misceval.callsimArray(Sk.builtin.str.prototype['pysine'], [frequency, wave, time]);
